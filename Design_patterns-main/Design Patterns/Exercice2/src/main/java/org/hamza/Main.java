...
import org.hamza.compresers.*;
import org.hamza.filters.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> filterClass = Class.forName("org.hamza.filters."+filterClassName);
            ImageFilter filter = (ImageFilter) filterClass.getDeclaredConstructor().newInstance();
            framework.setFilter(filter);

            Class<?> compressorClass = Class.forName("org.hamza.compresers."+compressorClassName);
